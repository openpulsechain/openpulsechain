...
import { Github, Menu, X, Shield, AlertTriangle, TrendingUp, Search, Loader2 } from 'lucide-react'
    ...
    <header className="border-b border-white/5 bg-gray-950/60 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-1.5">
        <Link to="/" className="flex items-center gap-1.5">
          <img src="/logo.png" alt="OpenPulsechain" className="h-8 w-8 rounded-full" />
